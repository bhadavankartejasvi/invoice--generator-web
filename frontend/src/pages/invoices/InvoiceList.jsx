        ...
        <div className="p-6 border-b border-slate-200 flex flex-wrap gap-4 items-center justify-between">
          <div className="flex gap-4">
            <button className="flex items-center gap-2 text-sm text-slate-600 font-medium hover:text-slate-900">
              ...
              Quick filter by client name
            </button>
            <div className="h-5 w-px bg-slate-200"></div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Date Range</span>
              <button className="text-sm font-semibold text-slate-900">Last 30 Days <span className="text-slate-400">▼</span></button>
            </div>
            <div className="h-5 w-px bg-slate-200"></div>
            <div className="flex items-center gap-3">
              <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Status</span>
              <div className="flex gap-2 text-xs font-semibold">
                <button className="text-slate-900 bg-slate-100 px-2 py-1 rounded">ALL</button>
                <button className="text-slate-500 hover:text-slate-900 px-2 py-1">PAID</button>
                <button className="text-slate-500 hover:text-slate-900 px-2 py-1">PENDING</button>
              </div>
            </div>
          </div>
